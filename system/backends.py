...
class UserModelBackend(ModelBackend):
    ...
    Авторизация по email и по логину (свой бекенд аутентификации 41
    https://proghunter.ru/articles/django-base-2023-authorization-by-email-and-login-custom-authentication-backend
    """
